...
3. The hit/slash motion is a runtime bridge driven by real Lua attack events, not the original skill prefab/timeline/effect playback yet.
...
2. Replace the runtime slash bridge with original skill prefab/timeline playback and completion callbacks.
