...
$UnityLog = Join-Path $Reports "unity_119_route_skeletongraphic_mesh_bounds.log"
$ClickLog = Join-Path $Project "logs\unity_119_click_validation.log"
$ReportScript = Join-Path $Base "_restore_tools\scripts\maininterface119_route_skeletongraphic_mesh_bounds_report.py"
...
Write-Host "[GirlsWarRestore][119] Tracing route SkeletonGraphic mesh bounds and CanvasRenderer submesh material"
$unityExit = Invoke-UnityMethod -Method "GirlsWarRestore.MainInterface119RouteSkeletonGraphicMeshBoundsTrace.Trace" -Log $UnityLog
Start-Sleep -Seconds 5

Write-Host "[GirlsWarRestore][119] Running MainInterface click validation"
...
Write-Host "[GirlsWarRestore][119] Writing final report"
python $ReportScript
exit $unityExit
