...
BUNDLE_REL = Path("extracted/unity/clean_unityfs_slices/download/roleprefabsandres/paintingprefabandres/1005.assetbundle")
BUNDLE = MERGED / BUNDLE_REL
MERGED_RAW_DIR = MERGED / "extracted" / "unity" / "raw_textassets" / "download_roleprefabsandres_paintingprefabandres_1005"
UNITY_RAW_DIR = PROJECT / "Assets" / "RestoreData" / "hero1005_spine_source_raw" / "paintingprefabandres_1005"
UNITY_OLD_DIR = PROJECT / "Assets" / "RestoreData" / "hero1005_spine_source" / "paintingprefabandres_1005"

OUT_CSV = RESTORE_REPORTS / "maininterface_124_hero1005_spine_raw_textassets.csv"
OUT_JSON = RESTORE_REPORTS / "maininterface_124_hero1005_spine_raw_textassets_summary.json"
OUT_MD = REPORTS / "MAININTERFACE_124_HERO1005_SPINE_RAW_TEXTASSETS.md"
...
def main() -> None:
    ...
    readme = [
        "# Hero 1005 Raw Spine Source",
        "",
        "These `.skel.bytes` and `.atlas.txt` files were re-extracted from Unity TextAsset `m_Script` with `surrogateescape`.",
        "The older `hero1005_spine_source` files are kept as UI123 evidence; this raw folder is the UI124 Spine import input.",
        "",
        "Use `Painting_1005` main-only first for the home lobby SkeletonGraphic mount.",
    ]
