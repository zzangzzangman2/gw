...
GameTools.CloseUIForm(UIFormId.UI_GuildRecruitNoticeView)
end)
...
function OnOpen(e)
EventSystem.AddListener(CommonEventId.OnGuildRespSetRecruitNotice,OnEventGuildRespSetRecruitNotice)
EventSystem.AddListener(CommonEventId.OnGuildLeave,OnGuildLeave)
RefreshInput(true)
Refresh()
end
function OnClose()
EventSystem.RemoveListener(CommonEventId.OnGuildRespSetRecruitNotice,OnEventGuildRespSetRecruitNotice)
...
t=ModulesInit.GuildMgr.guildInfo.recruitMsg
end
if a then
inputAcc.text=t
end
...
if ModulesInit.GuildMgr.guildInfo then
if ModulesInit.GuildMgr.guildInfo.recruitMsg==e then
GameTools.CloseUIForm(UIFormId.UI_GuildRecruitNoticeView)
return
end
end
...
ModulesInit.GuildMgr:ReqGuildSetRecruitNotice(e)
end
function OnEventGuildRespSetRecruitNotice(e)
UIUtil.ShowCommonTips(GameTools.GetLocalize("UI.guild.Manage.26",LanguageCategory.LangCommon))
GameTools.CloseUIForm(UIFormId.UI_GuildRecruitNoticeView)
end
