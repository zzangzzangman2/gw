...
ModulesInit.GlobalBattleEffectMgr.HideEffect(SysPrefabId.BattleYYJCampainBuff,0,false)
ModulesInit.GlobalBattleEffectMgr.ShowEffect(SysPrefabId.BattleYYJCampainBuff,t,0,50,0.4,0,false,function()
end)
end
end
