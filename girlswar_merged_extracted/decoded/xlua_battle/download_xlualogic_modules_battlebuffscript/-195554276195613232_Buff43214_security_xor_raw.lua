...
e.CurrHeroCtrl.HeroBattleInfo:ReduceHPAndMaxHPPer(t[4]*MillionCoe)
e.CurrHeroCtrl:ClearDamageConvertData(e.buffId)
end
function e.DoAction(e,a,i,n,o,t)
if e==nil or e.CurrHeroCtrl==nil or e.CurrHeroCtrl.HeroBattleInfo==nil or e.CurrHeroCtrl.HeroBattleInfo.CurrHP<=0 then
return
end
if t.buffTriggerTime==BuffTriggerTime.now then
e.CurrHeroCtrl.HeroBattleInfo:AddBuffValue(e.buffId,a[5],a[6])
elseif t.buffTriggerTime==BuffTriggerTime.normalAttacked or t.buffTriggerTime==BuffTriggerTime.smallSkillAttacked then
local t=43215
...
s.CheckAddDamageConvert(e,i.HeroId)
end
end
end
