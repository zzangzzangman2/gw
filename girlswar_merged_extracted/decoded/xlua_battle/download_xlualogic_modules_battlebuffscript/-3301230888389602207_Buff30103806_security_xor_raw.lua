...
ModulesInit.GlobalBattleEffectMgr.HideEffect(SysPrefabId.BattleMDLDCampainBuff,0,false)
ModulesInit.GlobalBattleEffectMgr.ShowEffect(SysPrefabId.BattleMDLDCampainBuff,t,-2,50,0.4,0,false,function()
end)
end
end
