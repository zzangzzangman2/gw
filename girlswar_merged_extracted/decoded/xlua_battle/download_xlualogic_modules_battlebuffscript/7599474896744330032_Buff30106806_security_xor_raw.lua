...
ModulesInit.GlobalBattleEffectMgr.HideEffect(SysPrefabId.BattleMeidiyaCampainBuff,0,false)
ModulesInit.GlobalBattleEffectMgr.ShowEffect(SysPrefabId.BattleMeidiyaCampainBuff,t,-2,50,0.4,0,false,function()
end)
end
end
