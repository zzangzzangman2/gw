...
for e=1,#t do
local e=t[e]
e:DelayPlayBuffEffect(1.2,a[2])
end
ModulesInit.GlobalBattleEffectMgr.HideEffect(SysPrefabId.BattleJingyuqianBuff,0,false)
local e=e.CurrHeroCtrl:GetFootPointPos()
ModulesInit.GlobalBattleEffectMgr.ShowEffect(SysPrefabId.BattleJingyuqianBuff,e.x,e.y,50,0.4,0,false,function()
end)
end
end
