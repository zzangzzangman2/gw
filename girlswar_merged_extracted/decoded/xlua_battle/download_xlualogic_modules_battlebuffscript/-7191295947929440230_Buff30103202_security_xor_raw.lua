...
ModulesInit.GlobalBattleEffectMgr.HideEffect(SysPrefabId.BattleYSWCampainBuff,0,false)
ModulesInit.GlobalBattleEffectMgr.ShowEffect(SysPrefabId.BattleYSWCampainBuff,t,0,50,0.4,0,false,function()
end)
end
end
