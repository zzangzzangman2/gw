...
ModulesInit.GlobalBattleEffectMgr.HideEffect(SysPrefabId.BattleFTXJCampainBuff,0,false)
ModulesInit.GlobalBattleEffectMgr.ShowEffect(SysPrefabId.BattleFTXJCampainBuff,t,0.5,50,0.4,0,false,function()
end)
end
end
