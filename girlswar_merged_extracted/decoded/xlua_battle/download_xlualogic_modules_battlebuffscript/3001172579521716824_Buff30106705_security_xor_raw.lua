...
ModulesInit.GlobalBattleEffectMgr.HideEffect(SysPrefabId.BattleZhendeCampainBuff,0,false)
local e=e.CurrHeroCtrl:GetFootPointPos()
ModulesInit.GlobalBattleEffectMgr.ShowEffect(SysPrefabId.BattleZhendeCampainBuff,e.x,e.y,50,0.4,0,false,function()
end)
end
end
