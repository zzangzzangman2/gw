...
ModulesInit.GlobalBattleEffectMgr.HideEffect(SysPrefabId.BattleCaoCaoCampainBuff,0,false)
local e=e.CurrHeroCtrl:GetFootPointPos()
ModulesInit.GlobalBattleEffectMgr.ShowEffect(SysPrefabId.BattleCaoCaoCampainBuff,e.x,e.y,50,0.4,0,false,function()
end)
end
end
