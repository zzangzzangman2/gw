...
ModulesInit.GlobalBattleEffectMgr.HideEffect(SysPrefabId.BattleGuanyuCampainBuff,0,false)
ModulesInit.GlobalBattleEffectMgr.ShowEffect(SysPrefabId.BattleGuanyuCampainBuff,t,1,50,0.4,0,false,function()
end)
end
end
end
