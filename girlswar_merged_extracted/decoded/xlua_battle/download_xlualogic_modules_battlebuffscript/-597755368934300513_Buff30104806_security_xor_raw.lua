...
ModulesInit.GlobalBattleEffectMgr.HideEffect(SysPrefabId.BattleCTZSCampainBuff,0,false)
ModulesInit.GlobalBattleEffectMgr.ShowEffect(SysPrefabId.BattleCTZSCampainBuff,t,-2.5,50,0.4,0,false,function()
end)
end
end
