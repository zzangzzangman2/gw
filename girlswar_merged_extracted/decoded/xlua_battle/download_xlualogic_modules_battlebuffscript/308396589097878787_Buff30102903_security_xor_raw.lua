...
ModulesInit.GlobalBattleEffectMgr.HideEffect(SysPrefabId.BattleNJCampainBuff,0,false)
ModulesInit.GlobalBattleEffectMgr.ShowEffect(SysPrefabId.BattleNJCampainBuff,t,0,50,0.4,0,false,function()
end)
end
end
